...
resumable emit/ingest batch harness, and the targeted search for the rare classes
--- assemble the evaluated set from their combined output under the composition
rule of Section~\ref{sec:refset}, and compute the agreement statistics of
Section~\ref{sec:gtvalidation}.
